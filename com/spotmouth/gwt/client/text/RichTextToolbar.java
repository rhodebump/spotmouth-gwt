 ...
 * the License.
 */
package com.spotmouth.gwt.client.text;
...
import com.spotmouth.gwt.client.ImagePickerDialog;
...
//        }
                ImagePickerDialog dialog = new ImagePickerDialog(mywebapp, itemHolder, extended);
            } else if (sender == createLink) {
                String url = Window.prompt("Enter a link URL:", "http://");
                if (url != null) {
                    extended.createLink(url);
                }
            }  else if (sender == createTable) {
                String tableHtml = "<table><tr>&nbsp;<td>&nbsp;</td></tr></table>";
                formatter.insertHTML(tableHtml);
    ...
    private PushButton createTable;
     ...
     */
    public RichTextToolbar(MyWebApp mywebapp, RichTextArea richText, ItemHolder itemHolder) {
        ...
        if (extended != null) {
            ...
            topPanel.add(createTable = createPushButton(images.createTable(),
                    strings.createTable()));
    ...
    //do add a table , we need to call Formatter.insertHTML()
}
