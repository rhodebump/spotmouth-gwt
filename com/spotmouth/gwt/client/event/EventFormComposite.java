 ...
 */
public class EventFormComposite extends Composite {

    @UiTemplate("EventFormComposite.ui.xml")
    interface DesktopBinder extends UiBinder<Widget, EventFormComposite> {
    }

    private static DesktopBinder desktopBinder = GWT.create(DesktopBinder.class);

    @UiTemplate("EventFormCompositeM.ui.xml")
    interface MobileBinder extends UiBinder<Widget, EventFormComposite> {
    }
    ...
    public EventFormComposite(Button cancelButton, SimplePanel imagePanel, MultiUploader multiUploader, DateTextField startDatePicker, DateTextField endDatePicker, TextField titleTextField,
